...
God.watch do |w|
  ...
  w.start = "${rails_runner} -e production lib/werte_aus_eibd_v2.rb" 
# Legacy-System:
...
God.watch do |w|
  ...
  w.start = "${rails_runner} -e production lib/werte_aus_system.rb" 
# Legacy-System:
...
#  w.uid = 'kw'
 # w.gid = 'users'
  ...
  w.start = "/home/kw/.rvm/rubies/ruby-2.2.1/bin/ruby /home/kw/.rvm/gems/ruby-2.2.1/bin/rails server -p3033"
# Legacy-System:
